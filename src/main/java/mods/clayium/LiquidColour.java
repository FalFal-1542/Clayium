 ...
 *
 * LiquidColour is a lambda function which is called by the renderer when it needs to know which colour it should use
 *   for a given itemstack (which may contain NBT information) and tintIndex.
 *   It needs to be registered in the ColorHandlerEvent.Item event
 */
